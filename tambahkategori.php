...
if(isset($_GET['kategori']) && isset($_GET['value'])){
...
$obj_kategori->insert($mysqli, $kategori, $value);
...
<table width="70%">
<tr>
<th><H1>Tambah Pilihan Kategori <?php echo $kategori;?> :</H1><br /><br /></th>
</tr>
<tr>
<td>
<form id="tambahkategori" action="tambahkategori.php" method="get">
<input type="hidden" value="<?php echo $kategori;?>" name="kategori" id="kategori" />
<input type="text" value="" name="value" id="value" />
<input class="buttom" name="submit" id="submit" tabindex="5" value="Tambah" type="submit">
