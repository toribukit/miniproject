...
<table width="70%">
<tr>
<th><H1>Daftar User</H1><br /><br /></th>
</tr>
<?php
$obj_user = new akunUser;
$obj_user->display($mysqli, $posisi, $batas);
echo $obj_user->display;
?>
<tr>
<td colspan="2">
<?php
...
if ( $page > 1 ) {
$link = $page-1;
$prev = "<a href='akun_user.php?page=$link'>Sebelumnya </a>";
}
else {
$prev = "Sebelumnya ";
}
...
if ( $page < $JmlHalaman ) {
$link = $page + 1;
$next = " <a href='akun_user.php?page=$link'>Selanjutnya</a>";
}
else {
$next = " Selanjutnya";
}
