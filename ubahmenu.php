...
if (isset($_GET['makanan']))
{
	...
	$obj_menu->update($makanan, $harga, $kategori_makanan, $Jenis_Makanan, $mysqli, $id);
...
<table>
<tr>
<td><H1>Update Menu</H1><br /><br /></td>
</tr>
<form action="ubahmenu.php" method="get">
<tr>
<td>
...
<td>Nama Menu</td>
<td>
<input id="makanan" name="makanan" placeholder="nama menu" required="" type="text" value="<?php echo $obj_menu->makanan;?>"> 
</td>
</tr>
<tr>
...
<option value =1 <?php if ($obj_menu->kategori_makanan == 1){print("selected = \"selected\" ");}?> >Makanan</option>
<option value =2 <?php if ($obj_menu->kategori_makanan == 2){print("selected = \"selected\" ");}?>>Minuman</option>
</select>
</td>
</tr>
<tr>
...
while ($row = mysqli_fetch_row($result)){
	if ($obj_menu->jenis_makanan == $row[0]){
...
<td>Harga (K)</td>
<td>
<input id="harga" name="harga" required="" placeholder="harga" type="text" value="<?php echo $obj_menu->harga;?>" > 
</td>
</tr>
<tr>
<td colspan="2">
<input type="hidden" name="id" id="id" value="<?php echo $id;?>" />
<input class="buttom" name="submit" id="submit" tabindex="5" value="Update Menu" type="submit">
</td>
</tr>
</form>
</table>
