...
<table width="100%">
<tr>
<td><H1>Daftar Akun Klien</H1> <br /></td>
</tr>
<tr>
<td>
<table width="100%" border="0" align="left">
<?php $obj_klien = new akun_klien;
echo $obj_klien->display($mysqli);
?>
</table>
</td>
</tr>
...
<br />
<div  class="form">
<form id="tambahKlien" name="tambahKlien" method="post" action="tambah_klien.php">
