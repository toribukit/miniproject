...
if(isset($_GET["id"]) && isset($_GET['kategori']) && isset($_GET['value'])){
$id = $_GET["id"];
...
$obj_kategori->edit($id, $mysqli, $kategori, $value);
...
else if (isset($_GET["id"]) && isset($_GET['kategori'])){
$id = $_GET["id"];
$id = mysqli_real_escape_string($mysqli, $id);
$kategori = $_GET["kategori"];
$kategori = mysqli_real_escape_string($mysqli, $kategori);
...
<table width="70%">
<tr>
<th><H1>Daftar Kategori :</H1><br /><br /></th>
</tr>
<tr>
<td>
<?php
$obj_kategori = new kategori;
$obj_kategori->retrieve($mysqli, $kategori, $id);
?>
<form id="ubahkategori" action="ubahkategori.php" method="get">
<input type="hidden" value="<?php echo $kategori;?>" name="kategori" id="kategori" />
<input type="hidden" value="<?php echo $id;?>" name="id" id="id" />
<input type="text" value="<?php echo $obj_kategori->retrieve;?>" name="value" id="value" />
<input class="buttom" name="submit" id="submit" tabindex="5" value="Ubah" type="submit">
